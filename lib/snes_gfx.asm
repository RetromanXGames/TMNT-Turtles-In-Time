...
compara_tempo_exibicao_2:  
  cmp #$0000
  beq tempo_exibicao_2_001
  dec
  WaitHV()
  bra compara_tempo_exibicao_2
tempo_exibicao_2_001:
  rep #$20
  lda.w #$7FFF
compara_tempo_exibicao_2_001: 
  cmp #$0000
  beq sair_splash_2
  dec
  WaitHV()
  bra compara_tempo_exibicao_2_001                                
sair_splash_2:
   sep #$20
  FadeOUT()
  WaitNMI()  
...
// WaitNMI - Wait For NMI Flag
//=============================
macro time_splash_logo() {
  tempo_exibicao_logo:
  FadeIN()           
  rep #$20
  lda.w #$ffff
compara_tempo_exibicao_logo:  
  cmp #$0000
  beq tempo_exibicao_logo_001
  dec
  WaitHV()
  bra compara_tempo_exibicao_logo
tempo_exibicao_logo_001:
  rep #$20
  lda.w #$7FFF
compara_tempo_exibicao_logo_001: 
  cmp #$0000
  beq sair_splash_logo
  dec
  WaitHV()
  bra compara_tempo_exibicao_logo_001                                
sair_splash_logo:
   sep #$20
  FadeOUT()
  WaitNMI()  
...
//==================================
// LoadVRAMLoadVRAM - Load GFX Data To VRAM
//==================================
//  SRC: 24-Bit Address Of Source Data
// DEST: 16-Bit VRAM Destination (WORD Address)
// SIZE: Size Of Data (BYTE Size)
